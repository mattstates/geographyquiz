...
throw new Error("Module parse failed: Unexpected token (147:71)\nYou may need an appropriate loader to handle this file type.\n| function generateQuestion() {\n|     question.innerHTML = `Where is <strong id='test'>${questions[Math.floor(Math.random() * questions.length)]}</strong>?`;\n|     questionCount !== 0 ? scoreEl.innerText = scoreUpdate(false) : void;\n| }\n| ");

/***/ })

})
//# sourceMappingURL=data:application/json;charset=utf-8;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiIwLmJiZDNmODc2NTZiM2I1M2E5ODdiLmhvdC11cGRhdGUuanMiLCJzb3VyY2VSb290IjoiIn0=